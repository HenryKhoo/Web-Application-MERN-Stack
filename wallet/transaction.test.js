...
/*
    wallet/transaction.test.js file: TTD Style for Transaction class.

    Test suite containing 12 -> 23 tests 
*/
describe("Transaction", ()=> {
    ...
    describe("input", ()=>{
        ...
        it("has the `timestamp` in the input", () =>{
    ...
    describe("rewardTransaction()", ()=>{
        ...
        it("creates one transtion for the miner with the `MINING_REWARD`",()=>{
